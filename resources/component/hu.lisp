...
(def resources hu
  (selectable-standard-object-tree-inspector.title (class-name)
    `xml,"Egy " `xml,class-name `xml," kiválasztása")
  (standard-object-filter.title (class-name)
    `xml,(capitalize-first-letter class-name) `xml," keresése")
  ...
  (standard-object-list-inspector.title (class-name)
    `xml,"Egy " `xml,class-name `xml," lista megjelenítése")
  (standard-object-tree-inspector.title (class-name)
    `xml,"Egy " `xml,class-name `xml," fa megjelenítése")
  (standard-object-inspector.title (class-name)
    `xml,"Egy " `xml,class-name `xml," megjelenítése")
  (standard-object-maker.title (class-name)
    `xml,"Egy új " `xml,class-name `xml," felvétele")
