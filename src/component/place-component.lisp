...
(def function make-place-component-content (component)
  (bind ((place (place-of component))
         ...
         (component-type (find-component-type-for-type type))
         (content (if (subtypep component-type 'alternator-component)
                      (make-instance component-type :default-component-type 'reference-component)
                      (make-instance component-type))))
