...
(def (generic e) make-component-place (component)
  (:documentation "Returns a PLACE or NIL if no such PLACE can be found for COMPONENT."))
...
(def (generic e) mark-component-to-be-rendered (component)
  (:documentation "Marks COMPONENT to be rendered next time RENDER-COMPONENT is called."))

(def (generic e) mark-component-rendered (component)
...
(def (generic e) cancel-editing (component)
  (:documentation "Reverts changes present under COMPONENT and leaves EDITING."))
...
(def (layered-function e) make-open-in-new-frame-command (component class prototype value)
  (:documentation "Creates an OPEN-IN-NEW-FRAME COMMAND that opens COMPONENT in a new FRAME."))
...
(def (layered-function e) make-hide-component-command (component class prototype value)
  (:documentation "Creates a HIDE-COMPONENT COMMAND that calls HIDE"))
...
(def (layered-function e) make-swith-to-alternative-commands (component class prototype value)
  (:documentation "Creates a list of SWITCH-TO-ALTERNATIVE COMMANDs to switch between alternative views for COMPONENT."))
...
(def (layered-function e) make-begin-editing-command (component class prototype value)
  (:documentation "Creates a BEGIN-EDITING COMMAND that starts EDITING under COMPONENT by calling EXECUTE-BEGIN-EDITING."))

(def (layered-function e) make-save-editing-command (component class prototype value)
  (:documentation "Creates a SAVE-EDITING COMMAND that actually saves the changes under COMPONENT by calling SAVE-EDITING and leaves EDITING by calling LEAVE-EDITING."))

(def (layered-function e) make-cancel-editing-command (component class prototype value)
  (:documentation "Creates a CANCEL-EDITING COMMAND that reverts the changes present under an COMPONENT and leaves EDITING."))

(def (layered-function e) make-store-editing-command (component class prototype value)
  (:documentation "Creates a STORE-EDITING COMMAND that actually stores the changes present under COMPONENT."))

(def (layered-function e) make-revert-editing-command (component class prototype instance)
  (:documentation "Creates a REVERT-EDITING COMMAND reverts the changes present under COMPONENT."))

(def (layered-function e) make-editing-commands (component class prototype instance)
  (:documentation "Creates a list of BEGIN-EDITING, SAVE-EDITING, CANCEL-EDITING, STORE-EDITING and REVERT-EDITING COMMANDs"))
