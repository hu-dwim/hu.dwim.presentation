    ...
    :components ((:file "l10n")
                 ...
                 (:module "component"
                  :components ((:file "mop" )
                               ...
                               (:file "extended-table" :depends-on ("component"))
                               ...
                               (:file "object-pivot-table" :depends-on ("pivot-table" "object-table"))
                               (:file "object-list-aggregator" :depends-on ("object-detail" "object-table"))
