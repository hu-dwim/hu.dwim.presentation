...
(def layered-method make-command-bar-commands ((component refreshable/mixin) class prototype value)
  (optional-list* (make-refresh-component-command component class prototype value) (call-next-layered-method)))

(def layered-method make-context-menu-items ((component refreshable/mixin) class prototype value)
  (optional-list* (make-menu-item (make-refresh-component-command component class prototype value)) (call-next-layered-method)))
