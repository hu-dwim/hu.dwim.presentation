...
(def (function e) make-cgi-serving-broker (path-prefix filename &key priority)
...
(def method produce-response ((entry-point cgi-serving-broker) request)
  (funcall (handler-of entry-point) (filename-of entry-point) (path-prefix-of entry-point)))

(def (function e) handle-cgi-request (filename path-prefix)
