...
(def localization-loader-callback presentation-localization-loader :hu.dwim.presentation "localization/")
...
;; TODO: resolve this duality among localize and localized-instance-name, why do we have both? [because -instance-name, which should really be /short-human-readable or somesuch, specifies the context of usage which may influence the implementation. but a cleanup is sure needed nevertheless...]
