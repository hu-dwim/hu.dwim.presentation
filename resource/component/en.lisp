...
(def resources en
  ...
  (selectable-standard-object-tree-inspector.title (class-name)
    (concatenate-string "Selecting an instance of " class-name))
  (standard-object-filter.title (class-name)
    (concatenate-string "Searching for instances of " class-name))
  ...
  (standard-object-list-inspector.title (class-name)
    (concatenate-string "Viewing instances of " class-name))
  (standard-object-tree-inspector.title (class-name)
    (concatenate-string "Viewing a tree of " class-name))
  (standard-object-inspector.title (class-name)
    (concatenate-string "Viewing an instance of " class-name))
  (standard-object-maker.title (class-name)
    (concatenate-string "Creating an instance of " class-name))
